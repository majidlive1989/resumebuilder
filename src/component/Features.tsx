...
import groupImage1 from "../img/group-image-1.png";
    ...
    <div className="flex flex-col items-center my-10 scroll-mt-12">
      ...
      <div className="flex flex-col md:flex-row items-center xl:-mt-10">
        ...
        <div className="px-4 gap-5">
          <div className="flex items-center justify-center max-w-md group cursor-pointer gap-4 py-3">
            <div className="p-6 hover:active: *:group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300   flex gap-6 rounded-xl transition-colors border-violet-300 bg-violet-100 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
